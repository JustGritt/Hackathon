 ...
 */
final class Version20230331122733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hk_video ADD title VARCHAR(128) NOT NULL');
        $this->addSql('ALTER TABLE hk_video ADD categories TEXT NOT NULL');
        $this->addSql('COMMENT ON COLUMN hk_video.categories IS \'(DC2Type:array)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hk_video DROP title');
        $this->addSql('ALTER TABLE hk_video DROP categories');
    }
}
