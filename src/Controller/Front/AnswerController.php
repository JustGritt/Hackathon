...
class AnswerController extends AbstractController
{
    ...
    public function new(Request $request, AnswerRepository $answerRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('front_app_answer_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    {
        return $this->render('front/answer/show.html.twig', [
            'answer' => $answer,
        ]);
    }
    ...
    public function edit(Request $request, Answer $answer, AnswerRepository $answerRepository): Response
    {
        ...
        return $this->renderForm('front/answer/edit.html.twig', [
            'answer' => $answer,
            'form' => $form,
        ]);
    }
